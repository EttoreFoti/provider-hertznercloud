# ====================================================================================
# Setup Project
PROJECT_NAME := provider-hertznercloud
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider HertznerCloud CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider HertznerCloud controllers
...
# This target prepares repo for your provider by replacing all "hertznercloud"
