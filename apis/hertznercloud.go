...
// Package apis contains Kubernetes API for the HertznerCloud provider.
package apis
...
import (
	...
	networkingv1alpha1 "github.com/crossplane/provider-hertznercloud/apis/networking/v1alpha1"
