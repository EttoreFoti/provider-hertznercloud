...
type CertificateParameters struct {
	...
	// The Certifiacte name
	Name string `json:"name"`

	// Simple labels to tag the Certificate
	//+optional
	Labels *map[string]string `json:"labels,omitempty"`

	// Choose between uploading a Certificate in PEM format or requesting a managed Let's Encrypt Certificate. If omitted defaults to uploaded. (uploaded | managed)
	//+optional
	//+immutable
